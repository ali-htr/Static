...
<script>
    ...
    onMount(async () => {
        itemsInCart = await fetch(
            "https://persiancup.ir/wp-json/sveltewp/cart",
        );
    ...
    function performSearch() {
        if (inputValue.trim()) {
            ...
            const url = `https://tadarokteb.ir/?s=${encodedSearchValue}&post_type=product`;
    ...
    onMount(async () => {
        ...
        itemsInCart = [
            {
                key: "ebc82ddcaa790d66bba665311ead3045",
                product_id: 14018,
                variation_id: 0,
                quantity: 1,
                name: "\u067e\u0648\u062f\u0631 \u0642\u0647\u0648\u0647 \u0641\u0648\u0631\u06cc \u0627\u0645\u0631\u06cc\u06a9\u0627\u0646\u0648 \u06a9\u0644\u0633 \u0645\u06cc\u062a",
                price: '<span class="woocommerce-Price-amount amount"><bdi>238,000 <span class="woocommerce-Price-currencySymbol">\u062a\u0648\u0645\u0627\u0646</span></bdi></span>',
                price_raw: 238000,
                line_subtotal:
                    '<span class="woocommerce-Price-amount amount"><bdi>238,000 <span class="woocommerce-Price-currencySymbol">\u062a\u0648\u0645\u0627\u0646</span></bdi></span>',
                line_total:
                    '<span class="woocommerce-Price-amount amount"><bdi>238,000 <span class="woocommerce-Price-currencySymbol">\u062a\u0648\u0645\u0627\u0646</span></bdi></span>',
                variation_data: "",
                image: "https://tadarokteb.ir/wp-content/uploads/2025/03/Americano-Class-Mate-1-150x150.webp",
                permalink:
                    "https://tadarokteb.ir/product/nstant-coffee-powder-class-mate-americano/",
                line_total_raw: 238000,
            },
        ];
...
<div class="bg-[#f1efff] !md:txs-h-132 txs-h-70">
    ...
    >
        <div
            class="hidden md:block txs-w-1137 txs-h-1 bg-[#46466D]/10 absolute txs-top-102"
        ></div>
        <!-- Mobile Menu Button -->
        <button
        ...
        <div class="txs-w-666 flex items-center">
            <a
                editablelink="d02d607a9d416e49c1119b5be82fb5c4"
                href="/"
                class="text-primary hidden md:block font-extrabold txs-fs-20"
            >
                Tadarok
            </a>
            <!-- Desktop Navbar -->
                    ...
                    >
                        {#if link.subgroups?.length > 0}
                            ...
                            >
                                ...
                                {#if hoveredLink === link}
                                    <div
                                        class="absolute txs-px-10 txs-w-190 txs-rounded-25 txs-pl-40 txs-h-328 top-full right-[-10px] bg-[#F6F6F6] py-2 z-10"
                                        style="border-radius:  0 calc(25*var(--tx)) calc(25*var(--tx)) 0 ;"
                                    >
                                        {#each link.subgroups as subgroup, index}
                                            {#if subgroup.subgroups?.length > 0}
                                                ...
                                                >
                                                    <a
                                                        href={subgroup.href}
                                                        class="block txs-rounded-12 txs-py-2 txs-h-30 bg-[#F6F6F6] {hoveredSubgroup ===
                                                        subgroup
                                                            ? 'bg-secondary text-white'
                                                            : ''} hover:text-white px-4 txs-py-20 text-primary hover:bg-secondary font-regular hover:font-semibold txs-fs-16 whitespace-nowrap flex items-center justify-between"
                                                    >
                                                        <div
                                                    ...
                                                    {#if hoveredSubgroup === subgroup}
                                                        <div
                                                            class="absolute txs-h-328 flex items-start justify-start overflow-y-auto txs-w-400 top-0 right-full bg-white py-2 z-20"
                                                            style="margin-right: calc(-10*var(--tx)); border-radius:  calc(25*var(--tx)) 0 0 calc(25*var(--tx)) ;"
                                                        >
                                                            <div
                                                                class="txs-rounded-50 columns-2 txs-pt-10"
                                                            >
                                                    ...
                                                    {:else}
                                                        <div
                                                            class="absolute txs-rounded-25 txs-h-328 flex flex-col items-start justify-start overflow-y-auto txs-w-400 top-0 right-full bg-white py-2 z-10"
                                                            style="margin-right: calc(-10*var(--tx));border-radius:  calc(25*var(--tx)) 0 0 calc(25*var(--tx)) ;"
                                                        >
                                                            <div
                                                                class="txs-rounded-50"
                                                            ></div>
                                                        </div>
                                                    {/if}
                                                </div>
            ...
            {#each navbarLinks as link}
                {#if link.icon === "search"}
                    <div class="relative txs-w-267 !md:txs-h-39 txs-ml-10">
                        <div
                            class=" items-center hidden md:flex left-0 absolute txs-w-267 z-10 transition-width duration-300 ease-in-out"
                        >
                            <input
                                type="text"
                ...
                {:else if link.icon === "login"}
                    ...
                    >
                        ...
                        >
                            <path
                                d="M0.646446 4.85355C0.451184 4.65829 0.451184 4.34171 0.646446 4.14645L3.82843 0.964466C4.02369 0.769204 4.34027 0.769204 4.53553 0.964466C4.7308 1.15973 4.7308 1.47631 4.53553 1.67157L1.70711 4.5L4.53553 7.32843C4.7308 7.52369 4.7308 7.84027 4.53553 8.03553C4.34027 8.2308 4.02369 8.2308 3.82843 8.03553L0.646446 4.85355ZM16 5H1V4H16V5Z"
                                fill="white"
                            />
                        </svg>
                    </a>
            ...
            >
                <div class="absolute flex items-center justif-center p-4">
                    <a editablelink="19171eff48fe671374c533d148f8b523" href="/">
                        <img
                            static="8cb75e9c2b046f5b8f582ae17bf93b54"
                            loading="lazy"
